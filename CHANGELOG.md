...
- Find/Replace dialog: Ctrl+V in find/replace input fields no longer triggers table paste into selected cells; input fields now receive normal text paste

## [0.11.0] - 2026-03-05

### Fixed

- Table saving: Prevent trailing spaces from being added to the last column when saving after adding or deleting columns

## [0.10.0] - 2026-02-11

### Changed

- Default for `visualTableCanvas.openBeside` changed from `true` to `false` (opens in same tab by default)

## [0.9.0] - 2026-02-10

### Added

- Shift+Arrow Keys: Extend cell selection range (like Excel)
- Ctrl+Shift+Arrow Keys: Extend selection to data boundary
- IME input support: Japanese/Chinese/Korean input works correctly in cells (Linux compatible)

### Fixed

- Selection highlight (blue background) now preserved after paste, delete, and other operations that re-render the table
